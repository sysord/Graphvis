...
// Modification: 
//
// - change CanvasRenderer.prototype.projectMouse: use only container offset for projection computation
// - set mouseuplistener on the canvas not on the full windows for avoid unselect on button click
// - change CanvasRenderer.prototype.drawText : due to firefox behavior when element position are 0,0 : convert Nan to 0
//
// http://www.sysord.com
//
...
//		}
		...
		//PP
		//console.log("MOUSE PROJECTION:" + x + " , " + y);
...
//			console.log(4, this.redrawReason[4]);
			...
			for (var index = 0; index < elements.length; index++) {
				...
				//PP: update style from mapped properties without redraw
...
//				console.log(selectBox);
	...
	CanvasRenderer.prototype.drawText = function(element, textX, textY) {
		...
		if (text != undefined) {
			//PP get NaN with Firefox but works fine with Chrome:
			if("" + textX == "NaN") textX = 0;
			if("" + textY == "NaN") textY = 0;
